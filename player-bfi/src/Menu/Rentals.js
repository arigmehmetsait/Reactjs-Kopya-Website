...
const Rentals = () => {
    ...
    return (
        <div style={{ backgroundColor: 'black' }}>
            ...
            <nav className="navbar bg-danger d-flex justify-content-center ">
                <h1 style={{ color: 'white', fontSize: '100%' }}>Rentals</h1>
            </nav>

            <div class="card bg-dark text-white">
                <img style={{ opacity: 0.5 }} src="https://player.bfi.org.uk/sites/default/files/styles/letterbox_640x280/public/blocks/hero-images/Rentals%20Landing%20Hero%20%28Moonlight%29%201440x614.jpg?itok=U9s1Y7cD" alt="..." />
                <div class="card-img-overlay">
                    <h5 class="card-title" style={{ fontSize: 60, fontWeight: "bold", position: 'relative', top: '25%', maxWidth: '40%' }}>Enjoy the latest releases <p class="card-text " style={{ fontSize: 20, fontWeight: 'lighter' }}>Rent new and acclaimed films, including those in cinemas now. Features start from £2.50 with BFI Member discount available</p></h5>
                </div>
            </div>
